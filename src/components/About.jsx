...
export default function About() {
  return (
    <div className='text-white t w-full h-[100vh] flex flex-col justify-center my-6' name='About'>
      ...
      <p className='my-12 text-[#777] max-w-[840px] text-xl md:text-2xl'>I'am Amine Hariri,Frontend web developer based in casablanca,I'like coding things from scratch and enjoy bringing ideas to life in the browser with modern technologies.
