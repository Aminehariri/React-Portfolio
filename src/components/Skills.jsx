  ...
  return (
    <div name='Skills' className='w-full  text-white '  >
            <div className='py-6'>
              ...
              <h4 className='max-w-[700px] text-[#777] text-xl'>To building websites and web applications I use modern technologies and techniques with best practices to make my clients satisfied 100% with the result...</h4>
            </div>
